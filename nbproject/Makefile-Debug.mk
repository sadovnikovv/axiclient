...
${OBJECTDIR}/GPIO.o: GPIO.cpp
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -std=c++11 -fPIC  -o ${OBJECTDIR}/GPIO.o GPIO.cpp

${OBJECTDIR}/axiopcjsonclient.o: axiopcjsonclient.cpp
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -std=c++11 -fPIC  -o ${OBJECTDIR}/axiopcjsonclient.o axiopcjsonclient.cpp

${OBJECTDIR}/device.o: device.cpp
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -std=c++11 -fPIC  -o ${OBJECTDIR}/device.o device.cpp

${OBJECTDIR}/easylogging++.o: easylogging++.cc
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -std=c++11 -fPIC  -o ${OBJECTDIR}/easylogging++.o easylogging++.cc

${OBJECTDIR}/function.o: function.cpp
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -std=c++11 -fPIC  -o ${OBJECTDIR}/function.o function.cpp

${OBJECTDIR}/simpleclient.o: simpleclient.cpp
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -std=c++11 -fPIC  -o ${OBJECTDIR}/simpleclient.o simpleclient.cpp
